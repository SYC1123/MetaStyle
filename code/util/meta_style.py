...
# 计算均值和标准差
def compute_statistics(x, eps=1e-6):
...
def mix_statistics(current_mean, current_std, style_mean, style_std, lambda_=0.5):
...
def apply_meta_style(features, mixed_mean, mixed_std):
    # 标准化
